...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setup_ui()
        # Cache Views
        self.dashboard_view = DashboardView(DashboardController())
        self.items_view = ItemsView(ItemController())
        self.suppliers_view = SuppliersView(SupplierController())
        self.stock_in_view = StockOperationsView(StockController(), "IN")
        self.stock_out_view = StockOperationsView(StockController(), "OUT")
        self.reports_view = ReportsView(ReportController())
        self.users_view = UserManagementView(UserController())
        self.devices_view = DeviceManagementView()
